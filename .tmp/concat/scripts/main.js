...
ARK3.Model = (function ($) {
    ...
    var characterOptions = {
        ...
        raceArray: [{
            ...
            per: 11,
            lck: 11,
            description: '<h3>You are a Human.</h3>' + humanDescripton
        }, {
            race: 'robot',
            str: 11,
            sta: 11,
            ...
            per: 5,
            lck: 11,
            description: '<h3>You are a Robot.</h3>' + robotDescripton
        }, {
            race: 'barbarian',
            str: 11,
            sta: 16,
            ...
            per: 5,
            lck: 11,
            description: '<h3>You are a Barbarian.</h3>' + barbarianDescripton
        }, {
            race: 'dwarf',
            str: 13,
            sta: 13,
            ...
            per: 8,
            lck: 11,
            description: '<h3>You are a Dwarf.</h3>' + dwarfDescripton
        }, {
            race: 'elf',
            str: 8,
            sta: 8,
            ...
            per: 11,
            lck: 11,
            description: '<h3>You are a Elf.</h3>' + elfDescripton
        }],
        ...
        professionArray: [{
            ...
            feet: chainBoots,
            weapon: longsword,
            description: '<h3>You are a warrior.</h3>' + warriorDescripton
        }, {
            profession: 'wizard',
            strBonus: 0,
            staBonus: 1,
            ...
            feet: clothSlippers,
            weapon: fire,
            description: '<h3>You are a wizard.</h3>' + wizardDescripton
        }, {
            profession: 'thief',
            strBonus: 0,
            staBonus: 1,
            ...
            feet: clothSlippers,
            weapon: dagger,
            description: '<h3>You are a thief.</h3>' + thiefDescripton
        }, {
            profession: 'explorer',
            strBonus: 2,
            staBonus: 0,
            ...
            feet: leatherBoots,
            weapon: axe,
            description: '<h3>You are a explorer.</h3>' + explorerDescripton
        }, {
            ...
            feet: leatherBoots,
            weapon: pistols,
            description: '<h3>You are a detective.</h3>' + detectiveDescripton
        }],
